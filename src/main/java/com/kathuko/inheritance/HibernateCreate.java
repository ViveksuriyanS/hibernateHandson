package com.kathuko.inheritance;
...
public class HibernateCreate {
	...
	public static void main(String[] args) {
		...
		Configuration con = new Configuration().configure("Inheritance.cfg.xml").addAnnotatedClass(TwoWheeler.class)
				.addAnnotatedClass(FourWheeler.class).addAnnotatedClass(Vehicle.class);
